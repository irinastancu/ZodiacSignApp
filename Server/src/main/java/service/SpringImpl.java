...
import proto.SpringZodiacSignGrpc;
import proto.Zodiac;
...
public class SpringImpl extends SpringZodiacSignGrpc.SpringZodiacSignImplBase {
    /*
    ...
    public SpringImpl() {
        ...
        this.zodiacSigns = HashMapFromTextFile("C:/Users/Ina/Desktop/Tema2/Tema-2-CNA/Server/src/main/resources/spring.txt");
    }
    ...
    public void getSpringSign(Zodiac.ZodiacRequest request, StreamObserver<Zodiac.SpringZodiacSignReply> responseObserver) {
        ...
        Zodiac.SpringZodiacSignReply reply = Zodiac.SpringZodiacSignReply.newBuilder().setMessage(zodiacSign).build();
