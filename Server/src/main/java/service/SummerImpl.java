...
import proto.SummerZodiacSignGrpc;
...
public class SummerImpl extends SummerZodiacSignGrpc.SummerZodiacSignImplBase {
    /*
    ...
    public SummerImpl() {
        ...
        this.zodiacSigns = HashMapFromTextFile("C:/Users/Ina/Desktop/Tema2/Tema-2-CNA/Server/src/main/resources/summer.txt");
    }
    ...
    @Override
    public void getSummerSign(Zodiac.SummerZodiacSignRequest request, StreamObserver<Zodiac.SummerZodiacSignReply> responseObserver) {
        ...
        Zodiac.SummerZodiacSignReply reply = Zodiac.SummerZodiacSignReply.newBuilder().setMessage(zodiacSign).build();
